...
import com.yechy.tvassserver.structure.DeviceBean;
...
public class UdpUtil {
    ...
    public static boolean verifySearchData(DatagramPacket packet) {
        ...
        int sendSeq;
        if (data[offset++] != '$' || data[offset++] != Constant.PACKET_TYPE_FIND_DEVICE_REQ_10) {
            return false;
        }
